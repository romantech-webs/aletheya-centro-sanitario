  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="aletheya-centro-sanitario";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Aletheya - Centro Sanitario Polivalente"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="aletheya-centro-sanitario"
          data-primary-color="#9c7446"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="aletheya-centro-sanitario";
